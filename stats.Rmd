...
o6 <- fulltbl_collapse %>% filter(!(str_detect(gene_id, "^G[0-9]"))) %>% 
  ...
  length()
# previously documented genes passing count filter and sig DE in one brain tissue,
# no name assigned by blast, but domain found in orf, 0
...
pass count filter and sig DE in one brain tissue, no name assigned by blast, but domain found in orf: `r o6`
